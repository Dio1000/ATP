...
/**
 * Equivalence operator object. It follows this truth table:
 * A | B | A <-> B
 * T | T |    T
 * T | F |    F
 * F | T |    F
 * F | F |    T
 * Thus, it can be said, that the equivalence of two formulas is True
 * only when they have the same truth value.
 */
